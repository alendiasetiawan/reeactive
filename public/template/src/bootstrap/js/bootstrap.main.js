document.addEventListener('livewire:initialized', () => {
    !function (t, e) {
        ...
        , m = t=>{
            ...
            ,
            "loading" === document.readyState ? (f.length || document.addEventListener("livewire:navigated", (()=>{
                for (const t of f)
                    t()
            }
            )),
        ...
        , C = new Set(["click", "dblclick", "mouseup", "mousedown", "contextmenu", "mousewheel", "DOMMouseScroll", "mouseover", "mouseout", "mousemove", "selectstart", "selectend", "keydown", "keypress", "keyup", "orientationchange", "touchstart", "touchmove", "touchend", "touchcancel", "pointerdown", "pointermove", "pointerup", "pointerleave", "pointercancel", "gesturestart", "gesturechange", "gestureend", "focus", "blur", "change", "reset", "select", "submit", "focusin", "focusout", "load", "unload", "beforeunload", "resize", "move", "readystatechange", "error", "abort", "scroll",]);
        function O(t, e) {
