            ...
            <div class="row">
                <div class="col-lg-6 col-12 mb-1">
                    ...
                    <x-vuexy.inputs.radio>
                        <x-vuexy.inputs.radio-input id="status-active" name="status" value="1" wire:model.live='status'/>
                        <x-slot:label for="status-active">Aktif</x-slot:label>
                    </x-vuexy.inputs.radio>
                    <x-vuexy.inputs.radio>
                        <x-vuexy.inputs.radio-input id="status-inactive" name="status" value="0" wire:model.live='status'/>
