<div>
    ...
    <div class="row">
        <div class="col-12">
            <x-cards.basic-card>
                <x-slot:cardTitle>Kelas Lepasan</x-slot:cardTitle>
                <div class="row">
    ...
    @endif">
        ...
        @forelse ($this->payments as $payment)
            <div class="col-lg-4 col-md-6 col-12">
                <a href="{{ route('admin::detail_lepasan_payment', ['id' => $payment->id]) }}" class="text-dark" wire:navigate>
                    <x-cards.role-card wire:key='{{ $payment->id }}'>
                        ...
                        <x-slot:subContent>
                            <small class="text-muted">
                                {{ \App\Helpers\TanggalHelper::convertImplodeDay($payment->day) }}
                                ({{ \Carbon\Carbon::parse($payment->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($payment->end_time)->format('H:i') }})
                                <br/>
