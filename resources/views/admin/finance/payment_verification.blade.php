...
<script data-navigate-once>
    document.addEventListener('livewire:initialized', tampilkanTable);
    document.addEventListener('livewire:navigated', tampilkanTableBaru);

    function tampilkanTable(e) {
