<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu {{ Route::is('trainer::dashboard') ? 'active' : '' }}">
                <a wire:navigate href="{{ route('trainer::dashboard') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ Route::is('trainer::active_member') ? 'active' : '' }}">
                <a wire:navigate href="{{ route('trainer::active_member') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
