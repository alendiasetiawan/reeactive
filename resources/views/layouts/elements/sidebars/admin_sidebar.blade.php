<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ Route::is('admin::payment_verification') || Route::is('admin::payment_verification.show') || Route::is('admin::registration_quota') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled" id="registrasi">
                    ...
                    <li class="{{ Route::is('admin::registration_quota') ? 'active' : '' }}">
