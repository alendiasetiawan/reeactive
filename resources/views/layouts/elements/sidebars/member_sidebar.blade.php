    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            @if ($user->type == 'Reguler')
                ...
                <li class="menu {{ Route::is('member::registration_portal') || Route::is('member::renewal_registration') || Route::is('member::open_class_registration') ? 'active' : '' }}">
                    <a href="{{ route('member::registration_portal') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <!--SPECIAL PROGRAM-->
                <li class="menu menu-heading">
                    <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>PROGRAM REEACTIVE</span></div>
                </li>

                <li class="menu {{ Route::is('member::referral_member') ? 'active' : '' }}">
                    <a wire:navigate href="{{ route('member::referral_member') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-check"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg>
                            <span>Referral Member</span>
                        </div>
                    </a>
                </li>
                <!--SPECIAL PROGRAM
