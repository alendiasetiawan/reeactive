...
<head>
    ...
    <meta name="description" content="Onlince coaching for muslimah">
    <title>{{ $title }} - Reeactive | Fit For Deen</title>
    <link rel="icon" type="image/x-icon" href="{{ asset('template/src/assets/img/favicon.ico') }}"/>
    <link href="https://fonts.googleapis.com/css2?family=Dongle:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500;1,600" rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('style/app-assets/vendors/css/vendors.min.css') }}">
    @stack('vendorCss')
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('style/app-assets/css/pages/page-misc.css') }}">
    @stack('pageCss')
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="content-body">
                <!-- Under maintenance-->
                <div class="row mb-2">
                    <a class="brand-logo mt-1 mx-1" href="/">
                        <img src="{{ asset('template/src/assets/img/logo/reeactive-3d.png') }}" alt="auth-img" width="100" height="30">
                    </a>
                </div>
    ...
    <!-- BEGIN: Theme JS-->
    <script src="{{ asset('style/app-assets/js/core/app-menu.js') }}"></script>
    <script src="{{ asset('style/app-assets/js/core/app.js') }}"></script>
    <!-- END: Theme JS-->
